...
| 01 Vision | MSTR-001 v1.2 (v1.1: autonomous bad-zone recovery, Select reframed as reset-and-randomize; v1.2: single-bank/no-save non-goals reopened as research questions, §9 future-direction topic list added), GDS-00 (updated to match v1.2), strategic assumptions register (7 assumptions; A5 reopened, A7's trigger already fired) | ✅ Amended 2026-07-22, new research threads opened |
