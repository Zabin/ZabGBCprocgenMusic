...
| FEAT-1090 | FS-109 | [fs-109-motif-recurrence-via-weighted-variant-selection.md](fs-109-motif-recurrence-via-weighted-variant-selection.md) | ✅ Authored 2026-07-26 (`BL-0010`/`ADS-102`, full 20-field spec); planned as [`IP-1090`](../implementation/packages/IP-1090-motif-recurrence-via-weighted-variant-selection.md), `READY`, G3-authorized — not yet built |
