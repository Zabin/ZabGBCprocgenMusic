...
| IP-9020 | Overload threshold recalibration — `OVERLOAD_THRESHOLD`/`ONSET_WINDOW_FRAMES` | `BL-0017` (Medium-High) | **COMPLETE** — [package](packages/IP-9020-overload-threshold-recalibration.md), `OVERLOAD_THRESHOLD` 20→7 (empirically recalibrated, not just the analytical VR-0007 formula — see package note), new T13 suite (2 checks), 77/77 tests, 8200-frame default-preset stress run clean; verification pending (G3-authorized 2026-07-25, this session) |
