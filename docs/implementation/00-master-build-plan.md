...
| IP-9020 | Overload threshold recalibration — `OVERLOAD_THRESHOLD`/`ONSET_WINDOW_FRAMES` | `BL-0017` (Medium-High) | **IN PROGRESS** — G3-authorized 2026-07-25 (run #33), [package](packages/IP-9020-overload-threshold-recalibration.md) |
