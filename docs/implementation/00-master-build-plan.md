...
`IP-0001` originally was before its own independent verification (`VR-0001`). **IP-0002 and
IP-0003 are now independently `VERIFIED`** ([VR-0002](verification/VR-0002-pulse-b-and-wave-channel.md),
[VR-0003](verification/VR-0003-noise-channel-and-density.md), both a genuinely fresh session) —
IP-0004 through IP-0007 remain owed.
