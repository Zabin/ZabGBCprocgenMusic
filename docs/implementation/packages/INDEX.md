...
| IP-9010 | [Channel-mix gating (remediation for `BL-0019`)](IP-9010-channel-mix-gating.md) | COMPLETE — 73/73 tests (new T12 suite), 8200-frame stress run clean; verification pending |
| IP-9020 | [Overload threshold recalibration (remediation for `BL-0017`)](IP-9020-overload-threshold-recalibration.md) | COMPLETE — 77/77 tests (new T13 suite), 8200-frame stress run clean; verification pending |
