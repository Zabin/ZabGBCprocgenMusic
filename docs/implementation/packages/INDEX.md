...
| IP-1070 | [Combinable generation schemes (Scheme E)](IP-1070-combinable-generation-schemes.md) | COMPLETE — 85/85 tests (new T14 suite), 8200-frame stress run clean; verification pending |
