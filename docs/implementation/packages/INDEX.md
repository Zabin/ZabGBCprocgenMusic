...
| IP-1090 | [Motif recurrence via weighted variant selection](IP-1090-motif-recurrence-via-weighted-variant-selection.md) | READY (G3 authorized — standing basis, see Master Build Plan) |
