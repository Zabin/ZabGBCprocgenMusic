...
| IP-8010 | [Remove the vestigial patch-point dicts (`BL-0064`)](IP-8010-remove-vestigial-patch-point-dicts.md) | **READY**, authorization **NOT GRANTED** — refactoring is never pre-authorized by standing rule; see the package's own reasoning. |
| IP-8020 | [Shared WRAM constants module (`BL-0065`)](IP-8020-shared-wram-constants-module.md) | **READY**, authorization **NOT GRANTED** — same standing-rule reasoning as `IP-8010`. |
| IP-9030 | [VBlank budget assertion (`BL-0069`) — re-scoped v2 2026-07-31, was *VRAM write-integrity detection*](IP-9030-vram-write-integrity-detection.md) | **COMPLETE** 2026-07-31 — 129/129 (`T1`-`T19`), authorization `RE-CONFIRMED 2026-07-31`. Awaits `09-package-verification`. Blocking Report and superseded v1 scope both retained in the package doc. |
