...
| IP-1110 | [Settings & control visibility](IP-1110-settings-and-control-visibility.md) | COMPLETE 2026-07-26 — 122/122 full-suite tests (T1-T18); one disclosed finding (a self-healing one-frame display lag specifically on a Select-reset frame, see IP-1110's own package doc) |
