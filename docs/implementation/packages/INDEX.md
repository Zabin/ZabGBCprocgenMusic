...
| IP-1090 | [Motif recurrence via weighted variant selection](IP-1090-motif-recurrence-via-weighted-variant-selection.md) | COMPLETE — 102/102 full-suite tests (T1-T16); independent verification owed |
