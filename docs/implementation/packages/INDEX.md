...
| IP-8010 | [Remove the vestigial patch-point dicts (`BL-0064`)](IP-8010-remove-vestigial-patch-point-dicts.md) | **COMPLETE** 2026-07-31 — byte-identical ROM proven, 129/129 identical check-name set. Awaits `09-package-verification`. |
| IP-8020 | [Shared WRAM constants module (`BL-0065`)](IP-8020-shared-wram-constants-module.md) | **READY**, authorization **GRANTED 2026-07-31**, same basis as `IP-8010`. |
