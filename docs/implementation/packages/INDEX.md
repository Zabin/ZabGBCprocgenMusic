...
| IP-1060 | [Arpeggio + duty-cycle variation](IP-1060-arpeggio-and-duty-cycle.md) | READY — G3-authorized (user's `BL-0024` request) |
| IP-1061 | [Vibrato + portamento](IP-1061-vibrato-and-portamento.md) | READY — G3-authorized (user's `BL-0024` request) |
