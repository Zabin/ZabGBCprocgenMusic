...
| IP-1080 | [Genre-aware style presets](IP-1080-genre-aware-style-presets.md) | COMPLETE — 93/93 full-suite tests (new T15 suite), 8200-frame stress run clean; not yet `VERIFIED` (independent verification owed to a fresh session) |
